...
class LoginActivity : AppCompatActivity() {
        ...
        endpoints.login(usuario).enqueue(object : Callback<JsonObject>{
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                ...
                200 -> {
                    ...
                    //direcionando o usuariopara a tela de servico
                ...
                403-> {tratarFalhaNaAutenticacao("E-mai e/ou senha invalidos.")}
    ...
    private fun tratarFalhaNaAutenticacao(mensagemError: String){
